...
description: "Grasas o lípidos: son el macronutriente más calórico y esenciales para tus hormonas y membranas celulares; sus tipos, ácidos grasos esenciales y fuentes."
...
Son también imprescindibles para que tu cuerpo absorba las [vitaminas](/nutricion/micronutrientes/vitaminas), concretamente las [liposolubles](/nutricion/micronutrientes/vitaminas/liposolubles) (A, D, E y K), para fabricar las hormonas que regulan el metabolismo, el estrés y la reproducción —las **hormonas esteroideas**, como el cortisol, la testosterona o el estrógeno— y para mantener las paredes que delimitan cada una de tus células —las **membranas celulares**—. La cantidad importa menos que la calidad de las fuentes.
